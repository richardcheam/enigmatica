...
- The web game shows the photographed clue rather than printing spaced coordinate pairs again.
- The first puzzle teaches the custom board through its accompanying source panel.
- The terminal version includes a text board and a compact digit string because it cannot display image clues.
